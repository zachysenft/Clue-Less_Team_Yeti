...
public class BoardGame{
    ...
    public void newGame() {
        ...
        ArrayList<cardLists> cards = generateWinCondition();
        storeWinCondinDB();
    ...
    public ArrayList<cardLists> generateWinCondition(){
        ...
        cardLists[] array_cards = cardLists.values();
        ArrayList<cardLists> cards = new ArrayList<cardLists>(Arrays.asList(array_cards));
    ...
    public void dealCards(ArrayList<cardLists> cards) {
